...
const (
	...
	// AI Issues (separate graphs from PR runs).
...
var agentStageRegistry = []agentStage{
	...
	{Name: "security.scan", Kind: kindSecurity, Phase: jobPhaseScan, Caps: capExecUntrusted, Timeout: 600 * time.Second, CheckRun: "AppSec Gate"},
	{Name: "security.publish", Kind: kindSecurity, Phase: "", Caps: capGitHubWrite | capClickHouseWrite, Timeout: 120 * time.Second, CheckRun: "AppSec Gate"},
