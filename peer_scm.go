...
// peer_scm_issues.go, both under scope scm:pm. Code delivery (push credentials +
// pull-request creation) lives in peer_scm_pr.go under the narrower scope scm:pr
// — the only scope that can write code.
